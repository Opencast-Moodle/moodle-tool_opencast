...
class workflowconfiguration_helper {
    ...
    /**
     * Determines whether all requirements to provide the upload configuration panel to the teachers in upload page are met.
     *
     * @return boolean whether or the upload configuration panel could be provided to the users.
     */
