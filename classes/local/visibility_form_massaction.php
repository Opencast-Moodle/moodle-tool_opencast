    ...
    public function definition() {
        ...
        if (!empty($videoslisthtmlitem)) {
            ...
            $explanation = html_writer::tag(
                'p',
                get_string(
                    'massaction_selectedvideos_list',
                    'tool_opencast',
        ...
        $radioarray[] = $mform->addElement(
            'radio',
            'visibility',
            get_string('visibility_massaction', 'tool_opencast'),
        ...
        $radioarray[] = $mform->addElement(
            ...
            'visibility',
            '',
            get_string('visibility_show_massaction', 'tool_opencast'),
            1
        );
        ...
        if ($groupvisibilityallowed && !empty($groups)) {
            $radioarray[] = $mform->addElement(
                ...
                'visibility',
                '',
                get_string('visibility_group_massaction', 'tool_opencast'),
                2
            );
        }
