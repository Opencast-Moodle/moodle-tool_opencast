...
final class upload_ingest_with_configpanel_test extends advanced_testcase {
     ...
     *
     * @covers \tool_opencast\local\upload_helper \tool_opencast\local\workflowconfiguration_helper
    ...
    public function test_upload_ingest_configpanel(): void {
        ...
        set_config('ingestupload_1', 1, 'tool_opencast');
        set_config('uploadworkflow_1', 'fast', 'tool_opencast');
        set_config('enableuploadwfconfigpanel_1', 1, 'tool_opencast');
        ...
        $filename = $CFG->dirroot . '/admin/tool/opencast/tests/fixtures/test.mp4';
        ...
        // Check upload job.
        $jobs = $DB->get_records('tool_opencast_uploadjob');
        ...
        $uploadjob = $DB->get_record('tool_opencast_uploadjob', ['opencasteventid' => $opencasteventid]);
