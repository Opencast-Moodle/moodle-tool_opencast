...
final class privacy_test extends provider_testcase {
    ...
    public function test_get_metadata(): void {
        ...
        $this->assertEquals('tool_opencast_uploadjob', $table->get_name());
        ...
        $this->assertEquals('privacy:metadata:tool_opencast_uploadjob', $table->get_summary());
    ...
    public function test_export_user_data(): void {
        ...
        // Test the created tool_opencast records matches the test number of jobs specified.
        $jobs = $DB->get_records('tool_opencast_uploadjob', ['userid' => $teacher->id]);
        ...
        // Test the tool_opencast data is exported at the Course context level.
    ...
    public function test_delete_data_for_all_users_in_context(): void {
        ...
        $blockopencast = $DB->get_records('tool_opencast_uploadjob', ['userid' => $teacher->id]);
    ...
    public function test_delete_data_for_user(): void {
        ...
        // Test the created tool_opencast records for Teacher 1 equals test number of jobs specified.
        $jobs = $DB->get_records('tool_opencast_uploadjob', ['userid' => $teacher1->id]);
        $this->assertCount(3, $jobs);

        // Test the created tool_opencast_uploadjob records for Teacher 2 equals 1.
        $jobs = $DB->get_records('tool_opencast_uploadjob', ['userid' => $teacher2->id]);
        $this->assertCount(1, $jobs);

        // Test the deletion of tool_opencast_uploadjob records for Teacher 1 results in zero records.
        ...
        // Test that Teacher 2's single tool_opencast_uploadjob record still exists.
    ...
    public function test_delete_data_for_users(): void {
        ...
        // Test the created tool_opencast records for Teacher 2 equals test number of jobs specified.
        $jobs = $DB->get_records('tool_opencast_uploadjob', ['userid' => $teacher2->id]);
        $this->assertCount(1, $jobs);
