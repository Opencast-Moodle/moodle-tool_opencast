...
$string['jwt_algorithm'] = 'Signing algorithm';
$string['jwt_algorithm_desc'] = 'Specifies the algorithm used to cryptographically sign the token.';
$string['jwt_annotationroles'] = 'Annotation-Tool roles';
$string['jwt_annotationroles_desc'] = 'A comma-separated list of roles to be used as the user role claim when accessing Opencast Annotation-Tool.';
$string['jwt_editorroles'] = 'Editor roles';
$string['jwt_editorroles_desc'] = 'A comma-separated list of roles to be used as the user role claim when accessing Opencast Editor.';
$string['jwt_enabled'] = 'Enable JWT Authenticahtion';
$string['jwt_enabled_desc'] = 'By enabling this authentication feature, moodle would utilise the jwt in required interaction with Opencast in order to grant access to the resources.';
$string['jwt_error_iframetokenrequestfailed'] = 'An error occured while trying to refresh access token in JWT  player iframe';
$string['jwt_error_invalidtoken'] = 'The JWT access token is invalid!';
$string['jwt_error_issuingtokenfailed'] = 'JWT: Unable to issue an access token!';
$string['jwt_error_nomatchingurl'] = 'Unable to process the video proxy request because the URL is undefined.';
...
$string['jwt_settingsheader'] = 'JWT Configuration';
$string['jwt_settingsheader_desc'] = 'Use this section to configure the settings for JSON Web Token (JWT) authentication.';
$string['jwt_studioroles'] = 'Studio roles';
$string['jwt_studioroles_desc'] = 'A comma-separated list of roles to be used as the user role claim when accessing Opencast Studio.';
$string['jwt_tokenduration'] = 'Token lifetime (duration)';
$string['jwt_tokenduration_desc'] = 'Specifies how long, in seconds, a token is valid before expiring.';
$string['jwt_videoproxytokenduration'] = 'Video proxy token lifetime';
$string['jwt_videoproxytokenduration_desc'] = 'Defines how long a video proxy token remains valid before it expires, specified in seconds. This applies to video proxy scenarios such as Opencast H5P Extensions.<br><br>Since the video proxy method does not support token refresh, it is strongly recommended to use a lifetime between 2 and 4 hours (in seconds).';
